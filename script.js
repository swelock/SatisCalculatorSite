...
const translations = {
    ru: {
        ...
        'platform-main': 'Универсальная платформа означает, что Satisfactory Calculator — это продвинутая система, которая делает все, что вам нужно для расчета производства — и вашего бизнеса.',
